<h1 class="page-header">CRUD Alumnos </h1>


    <a class="btn btn-primary pull-right" href="?c=cliente&a=Crud">Agregar Alumno</a>
    <a class="btn btn-primary pull-right" href="?c=maestro&a=Crud">Agregar Maestro</a>
<br><br><br>

<table class="table  table-striped  table-hover" id="tabla">
    <thead>
        <tr>
        <th style="width:120px; background-color: #5DACCD; color:#fff">Matricula</th>
